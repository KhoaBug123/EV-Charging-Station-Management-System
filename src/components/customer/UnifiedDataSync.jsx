 ...
 * Component này chạy trong background để sync data giữa các store
 */
const UnifiedDataSync = ({ children }) => {
    ...
    }, [user, initialized, bookingHistory.length, initializeMockData, syncAllStores, initializeWithUserData, setInitialized]);
