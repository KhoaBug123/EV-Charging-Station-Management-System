...
export const VIETNAMESE_TEXTS = {
    ...
    home: {
        ...
        subtitle: "Quản lý trạm sạc xe điện hiệu quả với nền tảng toàn diện của chúng tôi. Giám sát thời gian thực, đặt chỗ thông minh và thanh toán liền mạch.",
        features: {
            fastCharging: {
                title: "Sạc siêu nhanh",
                description: "Sạc DC siêu nhanh lên đến 250kW cho việc nạp điện nhanh chóng",
            },
            wideNetwork: {
        ...
        whyChooseSubtitle: "Các tính năng tiên tiến cho quản lý sạc xe điện hiện đại",
        readyToStart: "Sẵn sàng bắt đầu sạc?",
        readyToStartSubtitle: "Tham gia cùng hàng nghìn tài xế xe điện đang sử dụng mạng lưới sạc SkaEV",
    ...
    stations: {
        ...
        selectStationDescription: "Chọn một trạm sạc từ danh sách để xem thông tin chi tiết và đặt lịch.",
        ...
        bookingSuccess: "Đặt chỗ thành công tại {stationName}! Mã đặt chỗ: {bookingId}",
    },
    ...
    history: {
        ...
        noBookingsDescription: "Bạn chưa có lần đặt chỗ nào. Hãy tìm và đặt trạm sạc đầu tiên!",
